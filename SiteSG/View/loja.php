    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4">
                <!-- Produto 1 -->
                <div class="card">
                    <img src="caminho/para/foto1.jpg" class="card-img-top" alt="Produto 1">
                    <div class="card-body">
            ...
            <div class="col-lg-4">
                <!-- Produto 2 -->
                <div class="card">
                    <img src="caminho/para/foto2.jpg" class="card-img-top" alt="Produto 2">
                    <div class="card-body">
            ...
            <div class="col-lg-4">
                <!-- Produto 3 -->
                <div class="card">
                    <img src="caminho/para/foto2.jpg" class="card-img-top" alt="Produto 3">
                    <div class="card-body">
            ...
            <div class="col-lg-4">
                <!-- Produto 4 -->
                <div class="card">
                    <img src="caminho/para/foto2.jpg" class="card-img-top" alt="Produto 4">
                    <div class="card-body">
            ...
            <div class="col-lg-4">
                <!-- Produto 5 -->
                <div class="card">
                    <img src="caminho/para/foto2.jpg" class="card-img-top" alt="Produto 5">
                    <div class="card-body">
            ...
            <div class="col-lg-4">
                <!-- Produto 6 -->
                <div class="card">
                    <img src="caminho/para/foto2.jpg" class="card-img-top" alt="Produto 6">
                    <div class="card-body">
            ...
            <div class="col-lg-4">
                <!-- Produto 7 -->
                <div class="card">
                    <img src="caminho/para/foto2.jpg" class="card-img-top" alt="Produto 7">
                    <div class="card-body">
            ...
            <div class="col-lg-4">
                <!-- Produto 8 -->
                <div class="card">
                    <img src="caminho/para/foto2.jpg" class="card-img-top" alt="Produto 8">
                    <div class="card-body">
            ...
            <!-- Repita a estrutura para os outros produtos -->
            <div class="col-lg-4">
                <!-- Produto 9 -->
                <div class="card">
                    <img src="caminho/para/foto9.jpg" class="card-img-top" alt="Produto 9">
                    <div class="card-body">
